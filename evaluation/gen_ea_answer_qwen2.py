...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ea-model-path",
        type=str,
        default="/data/jianghaoyun/EAGLE/02_train_ckpt/last_4w_hass/state_37",
        help="The path to the weights. This can be a local folder or a Hugging Face repo ID.",
    )
    parser.add_argument("--base-model-path", type=str, default="/data/jianghaoyun/models/QwQ-32B",
                        help="1")
    parser.add_argument(
