...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        attention_mask: Optional[torch.Tensor],
        past_key_value: Optional[Tuple[torch.Tensor]] = None, # [MODIFIED] past_key_value is KVCache class
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        if position_ids is None:
            ...
            # [MODIFIED] fit the shape of position_ids
            position_ids = position_ids.view(-1, seq_length).long().to(inputs_embeds.device)
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
        # TODO!: check cache position and position ids device
